...
function ResultHeader(props) {
  ...
  const getResults = useCallback(() => {
    const built_string = '/api/count/' + searchString;
    fetch(built_string)
      .then((response) => response.json())
...
function ResultTable(props) {
  ...
  const getResults = useCallback(() => {
    ...
    const built_string = '/api/search/' + searchString + joiner + "offset="
